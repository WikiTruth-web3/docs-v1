---
title: Evidence Blind Box 铸造流程
description: 从本地加密到上链铸造的全流程示意。
sidebar:
  order: 10
---

### Evidence Blind Box 铸造流程

![铸造流程](/docs/create-process.svg)

Minter需要上传机密证据和 Box 基础展示信息，创建Evidence Blind Box的流程如下：
...
5. **铸造 Evidence Blind Box**：提交元数据文件CID和加密密钥到智能合约，并完成上链铸造。
