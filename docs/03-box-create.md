---
title: Evidence Blind Box Minting Process
...
The Minter needs to upload the confidential evidence and basic display information for the Box. The process for creating an Evidence Blind Box is as follows:
...
5. **Mint Evidence Blind Box**: Submit the metadata file CID and encryption key to the smart contract, and complete the on-chain minting.
