---
title: Bounties & Game Costs
description: Understand Evidence Market's automatic bounty allocation mechanism and the delay disclosure premium model.
sidebar:
  order: 12
---
...
### 1. Evidence Blind Box Rewards Allocation

![Rewards Allocation](/docs/rewards-allocation.svg)

When an Evidence Blind Box is successfully circulated (purchased) in the market, the transaction amount will be automatically allocated according to the following proportions. This not only rewards the provider of the truth but also incentivizes third-party participants who maintain market order.
